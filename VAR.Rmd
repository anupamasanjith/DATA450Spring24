...
ts.plot(kerala_ts, forecast_ts, col = c("blue","red"), xlab = "Time", ylab = "Rainfall (mm)", main = "Kerala: Actual vs Forecasted Values")
...
# Plot the real and forecasted values using ts.plot
ts.plot(Goa_ts, Goafore_ts, col = c("blue","red"),xlab = "Time", ylab = "Rainfall (mm)", main = "Goa: Actual vs Forecasted Values")
legend("topright", legend = c("Actual", "Forecast"), col = c("blue", "red"), lty = 1)
```
...
# Plot the real and forecasted values using ts.plot
ts.plot(Kar_ts, Karfore_ts, col = c("blue","red"),xlab = "Time", ylab = "Rainfall (mm)", main = "Karnataka: Actual vs Forecasted Values")
legend("topright", legend = c("Actual", "Forecast"), col = c("blue", "red"), lty = 1)
```
...
# Plot the real and forecasted values using ts.plot
ts.plot(Mad_ts, Madfore_ts, col = c("blue","red"),xlab = "Time", ylab = "Rainfall (mm)", main = "Maharashtra: Actual vs Forecasted Values")
legend("topright", legend = c("Actual", "Forecast"), col = c("blue", "red"), lty = 1)
```
...
# Plot the real and forecasted values using ts.plot
ts.plot(Lak_ts, Lakfore_ts, col = c("blue","red"),xlab = "Time", ylab = "Rainfall (mm)", main = "Lakshadweep: Actual vs Forecasted Values")
legend("topright", legend = c("Actual", "Forecast"), col = c("blue", "red"), lty = 1)
```
...
```{r}
plot(qr_code("https://stlawu.shinyapps.io/coastal_india_rainfall/"))
